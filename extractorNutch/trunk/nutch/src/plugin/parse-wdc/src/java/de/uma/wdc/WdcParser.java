 ...
 */
  public void setConf(Configuration conf) {
	...
	if(getConf().getBoolean("wdc.extractors.contain.RDFaExtractor", true))
	{
        factories.add(RDFaExtractor.factory);
	}
	if(getConf().getBoolean("wdc.extractors.contain.RDFa11Extractor", true))
	{
        factories.add(RDFa11Extractor.factory);
	}
	if(getConf().getBoolean("wdc.extractors.contain.MicrodataExtractor", false))
	{
	    factories.add(MicrodataExtractor.factory);
	}
	if(getConf().getBoolean("wdc.extractors.contain.GeoExtractor", false))
	{
	...
	this.evilNamespaces=Arrays.asList(getConf().getStrings("wdc.evilNamespaces", evilNs));
	this.notSoEvilNamespaces=Arrays.asList(getConf().getStrings("wdc.noEvilNamespaces", noEvilNs));
