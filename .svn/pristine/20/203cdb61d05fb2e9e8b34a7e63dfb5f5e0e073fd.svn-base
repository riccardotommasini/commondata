 ...
 */
public class WDCHTMLMetaExtractor implements Extractor.TagSoupDOMExtractor {
	...
	public final static ExtractorFactory<WDCHTMLMetaExtractor> factory = SimpleExtractorFactory
			.create(NAME, PopularPrefixes.createSubset("sindice"),
					Arrays.asList("text/html;q=0.02",
							"application/xhtml+xml;q=0.02"),
					"example-meta.html", WDCHTMLMetaExtractor.class);
