...
package org.webdatacommons.extractor;
...
public class IgnorantHcardExtractor extends EntityBasedMicroformatExtractor {
	...
	public final static ExtractorFactory<IgnorantHcardExtractor> factory = SimpleExtractorFactory
			.create("html-mf-hcard", PopularPrefixes.createSubset("rdf",
					"vcard"), Arrays.asList("text/html;q=0.1",
					"application/xhtml+xml;q=0.1"), "example-mf-hcard.html",
					IgnorantHcardExtractor.class);
